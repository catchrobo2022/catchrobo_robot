    ...
    ui(new Ui::Red)
{
    ...
    target_work = n.subscribe("target_work", sendtime, &Red::arrayback_target_work, this);
    target_box = n.subscribe("target_box", sendtime, &Red::arrayback_target_box, this);
...
void Red::arrayback_target_work(const std_msgs::Int8& msg){
  this->marker_obj(msg.data);
}

void Red::arrayback_target_box(const std_msgs::Int8& msg){
